...
const getEquipmentIcon = (equipment) => {
  const iconMap = {
  'Routeur': <Router className="w-4 h-4 text-blue-600 " />,
  'Switch': <Network className="w-4 h-4 text-green-600 " />,
  'Firewall': <Shield className="w-4 h-4 text-red-600 " />,
  'Serveur DHCP': <Server className="w-4 h-4 text-purple-600 " />,
  'Serveur DNS': <Database className="w-4 h-4 text-indigo-600 " />,
  'Load Balancer': <Cpu className="w-4 h-4 text-orange-600 " />,
  'BTS': <Antenna className="w-4 h-4 text-blue-500 " />,
  'NodeB': <Antenna className="w-4 h-4 text-green-500 " />,
  'eNodeB': <Antenna className="w-4 h-4 text-purple-500 " />,
  'gNodeB': <Radio className="w-4 h-4 text-pink-500 " />,
  'Wi-Fi AP': <Wifi className="w-4 h-4 text-cyan-600 " />,
  'Fibre Optique': <Zap className="w-4 h-4 text-yellow-600 " />,
  'Antenne GSM': <Antenna className="w-4 h-4 text-blue-400 " />,
  'Antenne UMTS': <Antenna className="w-4 h-4 text-green-400 " />,
  'Antenne LTE': <Antenna className="w-4 h-4 text-purple-400 " />,
  'Antenne Massive MIMO': <Radio className="w-4 h-4 text-pink-400 " />,
  'Small Cell': <Radio className="w-4 h-4 text-teal-500 " />,
  'Modem': <Router className="w-4 h-4 text-blue-500 " />,
  'Onduleur (UPS)': <Zap className="w-4 h-4 text-yellow-500 " />,
  'Générateur': <Zap className="w-4 h-4 text-red-500 " />,
};
...
const getNetworkIcon = (network) => {
  const iconMap = {
    'GSM (2G)': <Antenna className="w-4 h-4  dark:text-red-600" />,
    'UMTS (3G)': <Network className="w-4 h-4  dark:text-red-600" />,
    '4G (LTE)': <Wifi className="w-4 h-4  dark:text-red-600" />,
    '5G (NR)': <Radio className="w-4 h-4  dark:text-red-600" />,
    'Réseaux IP': <Router className="w-4 h-4  dark:text-red-600" />,
    'Liaisons Hertziennes': <Antenna className="w-4 h-4  dark:text-red-600" />,
    'Liaisons Optiques': <Zap className="w-4 h-4  dark:text-red-600" />,
    'Équipements CPE': <Wifi className="w-4 h-4  dark:text-red-600" />,
    'Répéteurs/Amplificateurs': <Settings className="w-4 h-4  dark:text-red-600" />,
  };
  return iconMap[network] || <Settings className="w-4 h-4" />;
};

function Sidebar({ onAddNode, darkMode, collapsed, onToggle, screenSize }) {
  ...
  // Utilise les props pour le contrôle d'état
  ...
  // Toggle button pour desktop seulement
  ...
  const SidebarContent = () => (
    ...
    } ${darkMode ? 'border-gray-700' : 'border-gray-200'} ${!isMobile ? 'border-r' : ''}`}>
      {/* Header */}
      <div className={`p-4 ${
        darkMode ? 'dark border-gray-700' : 'bg-white border-gray-200'
      } border-b shadow-sm`}>
        {!isCollapsed && (
          <>
  ...
  return (
    <div className={`sidebar-container relative transition-all duration-300 ease-in-out h-full ${
